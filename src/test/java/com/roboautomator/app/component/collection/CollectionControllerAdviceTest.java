...
public class CollectionControllerAdviceTest extends AbstractMockMvcTest {
        ...
        void shouldReturn400WhenCollectionIdIsNotValidUUID() throws Exception {
                ...
                var response = mockMvc
                                .perform(get(TEST_ENDPOINT + "/" + collectionId).contentType(MediaType.APPLICATION_JSON)
                                                .content(VALID_COLLECTION_UPDATE))
        ...
        void shouldReturn404WhenCollectionNotFound() throws Exception {
                ...
                var response = mockMvc
                                .perform(get(TEST_ENDPOINT + "/" + uuid.toString())
                ...
                assertThat(JsonPath.<String>read(responseAsString, "$.message"))
                                .isEqualTo("Collection with id \"" + uuid + "\" not found");
        }
        ...
        void shouldReturn404WhenCollectionTitleIsBlank() throws Exception {
                ...
                var response = mockMvc
                                .perform(post(TEST_ENDPOINT).contentType(MediaType.APPLICATION_JSON)
                                                .content(BLANK_TITLE_COLLECTION_UPDATE))
                                .andExpect(status().isBadRequest()).andReturn();
        ...
        void shouldReturn404WhenCollectionIndexIsNull() throws Exception {
                String BLANK_TITLE_COLLECTION_UPDATE = "{" + " \"title\": \"" + TITLE + "\"," + " \"tagTitle\": \""
                                + TAG_TITLE + "\"," + " \"tagColour\": \"" + TAG_COLOUR + "\"," + " \"images\": [],"
