...
public class CollectionControllerTestIT {
    ...
    void shouldGetAllCollectionsFromDatabase() throws JSONException {
        ...
        assertThat(collections.getJSONObject(0).get("id").toString()).contains("e3228e77-b31b-40e6-9bfe-0e4359fb1455");
        assertThat(collections.getJSONObject(1).get("id").toString()).contains("f8e6f439-e655-496c-8a50-b868ac933ecf");
    }
